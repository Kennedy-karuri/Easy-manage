    ...
    <nav class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start position-absolute ms-3 bg-white" id="sidenav-main">
        <div class="sidenav-header">
            ...
            <a class="navbar-brand m-0" href="javascript:;">
                ...
                <span class="ms-1 font-weight-bold">Easy-Manage</span>
            </a>
        </div>
                              ...
                              <form>
                                    ...
                                    <div class="col-md-12">
                                       <div class="profile-img-edit">
                                          <div class="crm-profile-img-edit">
                                             <img class="crm-profile-pic rounded-circle avatar-100" src="<?php echo get_template_directory_uri(  )?>" alt="avatar">
                                 ...
                                 <div class=" row align-items-center">
                                    <div class="form-group col-sm-6">
                                       ...
                                       <input type="text" class="form-control" id="fname" placeholder="input first name..." name="firstname">
                                    </div>
                                    <div class="form-group col-sm-6">
                                       <label for="lname">Last Name:</label>
                                       <input type="text" class="form-control" id="lname"  placeholder="input last name..." name="lastname">
                                    </div>
                                    <div class="form-group col-sm-6">
                                       <label for="uname">User Name:</label>
                                       <input type="text" class="form-control" id="uname"  placeholder="input username name..." name="username">
                                    </div>
                                    <div class="form-group col-sm-6">
                                       <label for="cname">Nickname:</label>
                                       <input type="text" class="form-control" id="cname"  placeholder="input nickname name..." name="nickname">
                                    </div>
                                    ...
                                    <div class="form-group col-sm-6">
                                       <label>Website:</label>
                                       <input type="text" class="form-control" id="website"  placeholder="input web link..." name="website">
                                    </div>
                                    <div class="form-group col-sm-12">
                                       <label>Geographical Info:</label>
                                       <textarea class="form-control" placeholder="input location" rows="5" style="line-height: 22px;">
